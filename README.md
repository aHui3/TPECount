...
## Dataset
TPECount is trained and tested on the **FSC-147 dataset**. The dataset is available for download from [here](https://github.com/cvlab-stonybrook/LearningToCountEverything).
